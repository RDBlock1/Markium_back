...
const FilterRow = ({ label, value, onChange, min = 0, max = 100, step = 1, showDollar = false }: FilterRowProps) => (
  <div className="space-y-3">
    ...
    <Slider value={value}  onValueChange={onChange} min={min} max={max} step={step} className="w-full bg-surface" />
  </div>
)
...
const UsersTableRow = ({ user, isExpanded }: UsersTableRowProps) => {
