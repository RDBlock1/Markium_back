            ...
            <div className={cn("mx-auto space-y-6", isMobile ? "max-w-full px-4" : "max-w-7xl px-8")}>
                ...
                {!hasMessages && (
                    <div className="flex flex-col items-center justify-center h-full min-h-[50vh] text-center px-4">
                        ...
                        <h2 className="text-xl font-semibold text-gray-200 mb-2">Welcome to Markium AI Market Analyzer</h2>
                        <p className="text-gray-300 max-w-md">
                            Welcome to Polymarket AI Analyzer! I can help you analyze prediction markets with AI-powered insights. Enter a market question or select from trending markets below.
                        </p>
                    </div>
                )}
