            ...
            <div className="flex items-center gap-4">
                ...
                <div ref={searchRef} className="relative w-96">
                    ...
                    <Input
                        ...
                        className="pl-10 bg-[#161b22] border-gray-700 text-white placeholder:text-gray-500 rounded-lg"
                    />
                ...
                {/* ⭐ Tags */}
                <div className="flex gap-x-2 overflow-x-auto scrollbar-hide">
                    {tags.slice(0, 8).map((tag) => {
                        ...
                        return (
                            <motion.button
                                ...
                                className={`px-3 py-1.5 text-sm rounded-lg whitespace-nowrap transition-colors ${isActive
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="border-gray-700 text-gray-300 hover:bg-gray-800 gap-2 bg-transparent">
                ...
                <DropdownMenu open={showFilterMenu} onOpenChange={setShowFilterMenu}>
                    <DropdownMenuTrigger asChild>
                        <Button variant="outline" className="border-gray-700 text-gray-300 hover:bg-gray-800 gap-2 bg-transparent relative">
