...
import PolymarketMiniChart from "@/components/market/mini-chart"
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-2">
                ...
                <span className="text-xs text-muted-foreground">{props.exp_data}</span>
              </div>
            </div>
        ...
        <CardContent>
          <div ref={chartWrapRef} className="w-full">
            <div className="flex items-center justify-between pb-2">
              <p className="text-sm font-medium">24h trend</p>
            </div>
            <PolymarketMiniChart
